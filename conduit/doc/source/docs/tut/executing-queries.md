...
In Conduit, each database table-class pairing is called an *entity*. Collectively, an application's entities are called its *data model*.
...
!!! note "Service Objects and Dependency Injection"
    ...
    this is called *dependency injection*. Unlike many frameworks, Conduit does not require a complex dependency injection framework; this is because you write the code to create instances of your controllers and can pass whatever you like in their constructor.
...
![Conduit Tutorial Run 4](../img/run4.png)
