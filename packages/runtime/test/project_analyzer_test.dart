...
void main() {
  test(
    "ProjectAnalyzer can find a specific class declaration in project",
    () async {
      ...
      expect(klass!.namePart.typeName.toString(), "ConsumerSubclass");
      expect(klass.extendsClause!.superclass.name.toString(), "Consumer");
    },
  );
}
