...
import 'package:conduit_mysql/src/mysql_query.dart';
import 'package:conduit_mysql/src/query_builder.dart';
...
void main() {
  ...
  test("Values get typed when used in predicate", () async {
    ...
    final builder = (q as MySqlQuery).createFetchBuilder();
  ...
  test("Values get typed when used as insertion values", () async {
    ...
    final builder = MySqlQueryBuilder(q as MySqlQuery);
