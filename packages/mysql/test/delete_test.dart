...
void main() {
  ...
  test("Deleting an object works", () async {
    context = await MySqlTestConfig().contextWithModels([TestModel, RefModel]);
  ...
  test("Deleting cascade object deletes other object", () async {
    context =
        await MySqlTestConfig().contextWithModels([GCascade, GCascadeInverse]);
