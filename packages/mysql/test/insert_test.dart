...
void main() {
  ...
  group("Method insert() in `Query`", () {
    ...
    test(
        ...
        () async {
      context = await MySqlTestConfig().contextWithModels([MultiUnique]);
    ...
    test(
        ...
        () async {
      context = await MySqlTestConfig().contextWithModels([GenUser, GenPost]);
    ...
    test("works correctly on an object with a default value for timestamp.",
        () async {
      context = await MySqlTestConfig().contextWithModels([GenTime]);
    ...
    test("works properly given a model with transient value.", () async {
      context = await MySqlTestConfig().contextWithModels([TransientModel]);
    ...
    test("works given an object with no keys.", () async {
      context = await MySqlTestConfig().contextWithModels([BoringObject]);
    ...
    test("works given an object with private fields.", () async {
      context = await MySqlTestConfig().contextWithModels([PrivateField]);
  ...
  group("Method insertMany(..) in `Query`", () {
    ...
    test("works given a list with two elements with different fields filled.",
        () async {
      context = await MySqlTestConfig().contextWithModels([NullableObject]);
